...
export const partnerProfiles: PartnerProfile[] = [
  ...
  },
  {
    ...
    story: "COCO'S FOOD est une SAS immatriculée à Rivière-Pilote, avec un établissement principal au marché et un siège à Rés Rosalie Soleil. La carte visible dans la conversation WhatsApp montre une cuisine de marché généreuse, avec plats mijotés, bowls frais, pâtes à la saucisse et assiettes complètes.",
    promise: 'Photos WhatsApp vérifiées, cuisine de marché, portions généreuses',
    eta: 'Préparation à la commande',
    specialty: 'Plats mijotés, riz bicolore, bowl avocat-betterave, spaghetti saucisse, assiettes plantain',
    highlights: [
      'Photos WhatsApp vérifiées',
      'Etablissement au marché',
      'Plats complets et bowls',
      'Tarifs indicatifs',
