...
export const driverReferences: DriverRef[] = [
  ...
  {
    name: 'Mattias Livreur',
    contact: '+596 696 50 39 66',
    zone: 'Martinique',
    type: 'indépendant',
    transport: 'Scooter',
    disponible: true,
    note: 'Contact WhatsApp direct. Livreur indépendant.',
    whatsapp: '596696503966',
  },
  {
    name: 'Orlanne BICTOLY',
    contact: '+33 7 69 43 37 29',
    zone: 'Dillon, Fort-de-France',
    type: 'indépendant',
    transport: 'Voiture',
    disponible: true,
    note: 'Déjà référencée comme livreuse Ninice. Secteur centre.',
    whatsapp: '33769433729',
  },
];