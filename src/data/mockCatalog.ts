...
export const mockProducts: LocalProduct[] = [
  ...
  {
    id: 'coco-board-signature',
    name: 'Combo marché signature',
    vendor: "Coco's Food",
    price: 15.00,
    category: 'Plats',
    description: 'Riz bicolore, viande mijotée et accompagnements maison, tarif indicatif observé sur la commande WhatsApp.',
    image: assetFromPublic('vendors/coco/coco-01-board.jpg'),
    zone: 'Rivière-Pilote',
    featured: true,
    available: true,
  },
  {
    ...
    price: 12.00,
    category: 'Bowl',
    description: 'Avocat, betterave, chou croquant et garniture végétale, présenté en bowl complet.',
    image: assetFromPublic('vendors/coco/coco-03-bowl.jpg'),
    zone: 'Rivière-Pilote',
    featured: true,
    available: true,
  },
  {
    id: 'coco-spaghetti-saucisse',
    name: 'Spaghetti saucisse',
    vendor: "Coco's Food",
    price: 10.00,
    category: 'Pâtes',
    description: 'Spaghetti sautés aux saucisses et légumes, portion généreuse.',
    image: assetFromPublic('vendors/coco/coco-04-spaghetti.jpg'),
    zone: 'Rivière-Pilote',
    featured: true,
    available: true,
  },
  {
    id: 'coco-assiette-complete',
    name: 'Assiette complète du marché',
    vendor: "Coco's Food",
    price: 16.50,
    category: 'Plats',
