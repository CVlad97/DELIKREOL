...
export const mockProducts: LocalProduct[] = [
  ...
  },
  {
    ...
    description: 'Glace artisanale à la canne. Sans sucre ajouté. Naturellement sucrée.',
    zone: 'Martinique',
    available: true,
    featured: true,
    ingredients: 'Canne.',
  ...
  },
  {
    ...
    price: 2,
    category: 'Desserts',
    description: 'Glace artisanale à la pastèque. Sans sucre ajouté. Rafraîchissant.',
    zone: 'Martinique',
    available: true,
    featured: true,
