...
export const mockProducts: LocalProduct[] = [
  ...
  // 22 produits — 2,50€ chaque — photos partenaires importées quand disponibles
  // ═══════════════════════════════════════════════════════
  {
...
// LES DELICES DE NINICE — Fort-de-France (Dillon)
  ...
  },
  {
    ...
    photoQuality: 'à valider',
    descQuality: 'validée',
    description: 'Glace artisanale à la cacahuète, annoncée sans lactose. Saveur gourmande et locale, allergène arachide à signaler clairement.',
    zone: 'Martinique',
    available: true,
    featured: true,
  ...
  },
  {
    ...
    photoQuality: 'à valider',
    descQuality: 'validée',
    description: 'Glace artisanale à la pistache, annoncée sans lactose. Parfum gourmand, à confirmer en disponibilité avant préparation.',
    zone: 'Martinique',
    available: true,
    featured: true,
  ...
  },
  {
    ...
    photoQuality: 'à valider',
    descQuality: 'validée',
    description: 'Glace artisanale cho’co annoncée sans lactose, préparée avec cacao, eau de coco et nan-nan. Référence validée dans le kit partenaire.',
    zone: 'Martinique',
    available: true,
    featured: true,
