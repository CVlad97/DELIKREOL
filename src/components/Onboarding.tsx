...
export function Onboarding({ onComplete }: OnboardingProps) {
 ...
 return (
 <div className="fixed inset-0 bg-gradient-to-br from-success to-accent z-50 flex flex-col">
 ...
 <button
 onClick={handleNext}
 className="w-full bg-white text-success py-4 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl transition-shadow flex items-center justify-center gap-2"
 >
