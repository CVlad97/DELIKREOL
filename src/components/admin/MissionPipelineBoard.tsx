...
const stageTone: Record<MissionStage, string> = {
 ...
 qualified:'border-input bg-muted',
 assigned:'border-primary/20 bg-primary/[0.05]',
 in_progress:'border-success/20 bg-success/[0.15]',
...
export function MissionPipelineBoard({ snapshot }: MissionPipelineBoardProps) {
 ...
 <span className={`rounded-full px-2 py-1 text-[10px] font-black ${mission.canTakeOrder ?'bg-success/[0.15] text-success' :'bg-rose-100 text-rose-800'}`}>
