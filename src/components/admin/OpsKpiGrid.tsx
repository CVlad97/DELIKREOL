...
export function OpsKpiGrid({ snapshot }: OpsKpiGridProps) {
 ...
 { label:'A qualifier', value: snapshot.kpis.awaitingQualification, hint:'site, WhatsApp, Telegram', icon: AlertTriangle, tone:'text-muted-foreground bg-muted border-input' },
 { label:'Missions en cours', value: snapshot.kpis.activeMissions, hint:'suivi terrain', icon: Target, tone:'text-success bg-success/[0.15] border-success/20' },
 ...
 { label:'CA estime', value: currency.format(snapshot.kpis.estimatedRevenue), hint: `commission ${currency.format(snapshot.kpis.estimatedCommission)}`, icon: CircleDollarSign, tone:'text-primary bg-primary/[0.05] border-primary/20' },
