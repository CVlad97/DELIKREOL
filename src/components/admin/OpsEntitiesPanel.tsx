...
export function OpsEntitiesPanel({ snapshot }: OpsEntitiesPanelProps) {
 ...
 <span className={`rounded-full px-3 py-1 text-xs font-black ${partner.complianceStatus ==='valid' ?'bg-success/[0.15] text-success' : partner.complianceStatus ==='expiring' ?'bg-muted text-muted-foreground' :'bg-red-100 text-red-800'}`}>
