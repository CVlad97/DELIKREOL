...
export function OnboardingForm({ isOpen, onClose, roleType }: OnboardingFormProps) {
 ...
 className="w-full px-4 py-3 border border-input rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent font-mono text-sm"
 rows={4}
 ...
 className="w-full px-4 py-3 border border-input rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
 required
 />
 </div>
 ...
 roleType ==='relay_host' ?'from-blue-500 to-cyan-500' :'from-success to-accent'
 } text-white p-6 rounded-t-3xl z-10`}>
 <div className="flex justify-between items-start">
 <div>
 <h2 className="text-3xl font-bold mb-2">
 {roleType ==='vendor' ?'Devenir Vendeur' :
 roleType ==='relay_host' ?'Devenir Point Relais' :'Devenir Livreur'}
 </h2>
 ...
 roleType ==='relay_host' ?'bg-blue-600 hover:bg-blue-700' :'bg-accent hover:bg-accent/90'
 }`}
 >
 Suivant
 </button>
