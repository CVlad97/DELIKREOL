    ...
    <div className={`bg-white rounded-2xl border border-primary/20 overflow-hidden ${compact ? '' : 'shadow-sm'}`}>
      ...
      <div className="p-4 border-b border-primary/[0.15]">
        ...
        <div className="relative">
          <button onClick={() => setShowList(!showList)} className="w-full flex items-center justify-between px-3 py-2 bg-muted rounded-xl text-sm text-foreground border">
              ...
              >
                ...
                {dist !== null && (
                  <div className="flex gap-1">
                    <button onClick={(e) => { e.stopPropagation(); window.open(getWazeLink({ latitude: p.latitude, longitude: p.longitude }), '_blank'); }} className="p-1.5 text-black hover:bg-muted rounded-lg" title="Ouvrir dans Waze">
