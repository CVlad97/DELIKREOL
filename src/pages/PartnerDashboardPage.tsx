...
export function PartnerDashboardPage() {
 ...
 <div>
 <p className="text-sm font-black uppercase tracking-[0.28em] text-primary/60">Portail partenaire</p>
 ...
 <CreditCard className="mt-1 h-5 w-5 shrink-0 text-success" />
 <div>
 <h2 className="font-black text-success">Terminal mobile de test</h2>
 ...
 <a href="/terminal-partenaire" className="rounded-2xl bg-success px-5 py-3 text-center text-sm font-black text-white">
 Ouvrir le terminal
 </a>
 </div>
 </section>

 <section className="mt-6 rounded-3xl border border-primary/20 bg-white p-5 shadow-sm">
 ...
 <span className="rounded-full bg-primary/[0.05] px-4 py-2 text-xs font-black uppercase tracking-[0.16em] text-primary">
 Validation admin
 </span>
 </div>
 <textarea
 ...
 className="mt-4 w-full rounded-2xl border border-primary/20 bg-[#fffaf3] px-4 py-3 text-sm outline-none focus:border-orange-300 focus:ring-4 focus:ring-orange-100"
 />
 <button
 type="button"
 disabled={sendingCorrection || correctionText.trim().length < 8}
 onClick={handleCorrectionSubmit}
 className="mt-4 inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-primary px-5 py-3 text-sm font-black text-white disabled:bg-slate-300"
 >
 ...
 <section className="mt-6 rounded-3xl border border-input bg-muted p-5">
 <div className="flex gap-3">
 <AlertCircle className="mt-1 h-5 w-5 shrink-0 text-muted-foreground" />
 <div>
 ...
 return (
 <article key={requirement.type} className="rounded-[1.5rem] border border-primary/20 bg-white p-5 shadow-sm">
 ...
 <span className={`rounded-full px-3 py-1 ${requirement.sensitive ?'bg-red-50 text-red-700' :'bg-success/[0.15] text-success'}`}>
 {requirement.sensitive ?'Stockage privé' :'Public possible'}
 </span>
 {requirement.expires && (
 <span className="rounded-full bg-primary/[0.05] px-3 py-1 text-primary">Expiration suivie</span>
 )}
 </div>
 ...
 className="block w-full rounded-2xl border border-primary/20 bg-[#fffaf3] px-4 py-3 text-sm"
 />
 </label>
 ...
 <section className="mt-8 rounded-3xl border border-emerald-100 bg-success/[0.15] p-5">
 <div className="flex gap-3">
 <ShieldCheck className="mt-1 h-5 w-5 shrink-0 text-success" />
 <div>
 <h2 className="font-black text-success">Principe de minimisation</h2>
 <p className="mt-1 text-sm leading-6 text-success">
