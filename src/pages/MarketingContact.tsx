...
export default function MarketingContact() {
 ...
 className="w-full px-4 py-3 border border-input rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
 ...
 className="w-full px-4 py-3 border border-input rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent resize-none"
 ...
 type="submit"
 disabled={loading}
 className="w-full inline-flex items-center justify-center px-6 py-3 bg-emerald-600 text-white rounded-lg hover:bg-success transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 <div className="flex-shrink-0 w-12 h-12 bg-success/[0.15] rounded-lg flex items-center justify-center">
 ...
 <div className="mt-12 p-6 bg-success/[0.15] rounded-xl">
 ...
 <a
 href="/become-partner"
 className="inline-flex items-center text-success hover:text-success font-medium"
 >
 Devenir partenaire
