...
export function CommunityFundPage() {
 ...
 className="text-xs text-emerald-400 hover:text-success mt-1 flex items-center gap-1"
 >
 ...
 <span className="inline-block text-xs px-2 py-1 rounded bg-success/[0.15]0/10 text-emerald-400 mt-1">
 ...
 <div
 className="bg-success/[0.15]0 h-2 rounded-full transition-all"
 ...
 className="w-full bg-success/[0.15]0 text-slate-950 px-4 py-2 rounded-lg hover:bg-emerald-400 transition-all font-medium"
 >
 Soutenir ce projet
 </button>
 </div>
 ...
 className="flex-1 bg-success/[0.15]0 text-slate-950 px-4 py-3 rounded-lg hover:bg-emerald-400 transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed"
 >
 Confirmer
 </button>
 <button
 ...
 prefMode ==='manual'
 ?'border-emerald-500 bg-success/[0.15]0/10 text-emerald-400'
 ...
 className="flex-1 bg-success/[0.15]0 text-slate-950 px-4 py-3 rounded-lg hover:bg-emerald-400 transition-all font-medium"
 >
 Enregistrer
 </button>
 <button
