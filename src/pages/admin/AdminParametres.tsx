...
export function AdminParametres() {
 ...
 <div className="bg-muted border border-input rounded-lg p-3 flex items-start gap-2">
 <AlertTriangle className="w-4 h-4 text-amber-600 mt-0.5" />
 <p className="text-xs text-muted-foreground">Le paiement en ligne est prévu en phase 2. Ne pas activer sans validation complète.</p>
 </div>
 )}
 ...
 <section className="mt-10 rounded-2xl border border-primary/20 bg-white p-5 shadow-sm">
 ...
 <span className="inline-flex w-fit rounded-full bg-primary/[0.05] px-3 py-1 text-xs font-black text-orange-800">
