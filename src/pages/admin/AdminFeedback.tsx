...
const TYPE_CONFIG: Record<FeedbackType, { label: string; icon: any; color: string }> = {
 ...
 suggestion: { label:'Suggestion', icon: Lightbulb, color:'text-amber-600 bg-muted' },
...
const STATUS_CONFIG: Record<FeedbackStatus, { label: string; color: string }> = {
 ...
 read: { label:'Lu', color:'bg-muted text-muted-foreground' },
...
export function AdminFeedback() {
 ...
 className="p-2 rounded-lg text-amber-600 hover:bg-muted transition"
 >
