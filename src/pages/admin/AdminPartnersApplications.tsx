...
export default function AdminPartnersApplications() {
 ...
 <div className="text-sm text-muted-foreground mb-1">Nouveaux</div>
 ...
 isUnread ?'bg-muted/50' :'hover:bg-muted'
 }`}
 >
 ...
 {isUnread && (
 <span className="px-2 py-0.5 text-[10px] font-bold bg-muted text-muted-foreground rounded-full uppercase tracking-wider">
 Non lu
 </span>
 )}
 </div>
 ...
 className="p-2 text-amber-600 hover:bg-muted rounded-lg transition-colors"
