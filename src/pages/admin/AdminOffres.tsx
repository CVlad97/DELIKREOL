...
export function AdminOffres() {
 ...
 <div className="mb-6 rounded-xl border bg-muted p-4 text-sm text-amber-900">
 ...
 <span className={`text-xs px-2 py-0.5 rounded-full ${offre.status ==='Actif' ?'bg-green-100 text-green-700' : offre.status ==='Phase 2' ?'bg-muted text-muted-foreground' :'bg-muted text-muted-foreground'}`}>
 {offre.status}
 </span>
