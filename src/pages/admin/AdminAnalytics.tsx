...
function SignupsByCategory() {
 ...
 { label:'Points relais', value: relays.length, icon: MapPin, color:'text-amber-600 bg-muted' },
...
function ActionRecommendations() {
 ...
 rec.priority ==='P1' ?'bg-muted text-muted-foreground' :'bg-success/[0.15] text-success'
 }`}>{rec.priority}</span>
...
export default function AdminAnalytics() {
 ...
 <div className="p-4 bg-muted border border-input rounded-2xl text-sm text-muted-foreground">
 ...
 Pour des analytics professionnels, configure <code className="bg-muted px-1 rounded">VITE_GA_ID</code> (Google Analytics) dans le fichier <code className="bg-muted px-1 rounded">.env</code>.
