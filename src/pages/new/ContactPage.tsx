...
export function ContactPage() {
 ...
 <input type="checkbox" required className="mt-0.5 w-4 h-4 rounded border-input text-primary focus:ring-primary/30" />
 ...
 <h2 className="text-lg font-bold text-foreground">Réseaux sociaux</h2>
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="inline-flex items-center gap-2 rounded-xl border border-border px-4 py-2 text-sm font-semibold text-foreground transition-colors hover:border-primary/30 hover:text-primary"
 >
 {social.icon}
 {social.label}
 </a>
