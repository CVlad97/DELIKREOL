      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          <select value={filterType} onChange={e => setFilterType(e.target.value)}
            className="px-4 py-2 rounded-xl border border-gray-200 text-sm bg-white outline-none focus:border-ring">
        ...
        <div className="space-y-4">
          {marches.length === 0 ? (
            ...
            <div key={m.id} className="bg-white rounded-2xl border border-gray-100 hover:border-primary/30 shadow-sm hover:shadow-md transition-all p-6">
