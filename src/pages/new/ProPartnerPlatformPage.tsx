...
export function ProPartnerPlatformPage() {
 ...
 <tbody>
 {PLATEFORMES.map((p, i) => (
 <tr key={i} className="border-t border-muted hover:bg-primary/10">
 ...
 p.integration ==='Partenaire direct possible' ?'bg-blue-100 text-blue-700' :'bg-secondary/15 text-secondary'
 }`}>
 {p.integration}
 </span>
 </td>
 ...
 {/* CTA CONTACT */}
 <section className="rounded-3xl border border-success/20 bg-success/[0.15] p-8">
 <h2 className="text-2xl font-black text-success mb-2">📲 Terminal partenaire mobile</h2>
 <p className="text-sm text-success mb-5">
 ...
 className="inline-flex items-center gap-2 px-6 py-3 bg-success hover:bg-success text-white font-bold rounded-2xl transition-all"
 >
