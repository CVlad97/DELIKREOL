        ...
        <div className="mx-auto max-w-6xl space-y-6">
          <div className="rounded-[2rem] border border-primary/20 bg-white p-6 shadow-sm">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.22em] text-primary">Espace client</p>
          ...
          <div className="rounded-[2rem] border border-primary/20 bg-white p-6 shadow-sm">
            <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Link to="/statut-commande" className="text-sm font-bold text-primary hover:underline">Suivre une commande</Link>
            </div>
                  ...
                  return (
                    <div key={order.id} className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div><p className="font-mono text-lg font-black text-primary">{number}</p><p className="text-xs text-gray-500">{formatDate(order.created_at)}</p><p className="mt-1 text-sm text-gray-600">{order.commune || 'Commune non précisée'} · {order.order_mode || order.mode || 'Mode non précisé'}</p></div>
