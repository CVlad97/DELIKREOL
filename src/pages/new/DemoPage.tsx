            ...
            <div className="bg-white rounded-3xl border border-gray-100 p-6 md:p-8">
              ...
              {step === 4 && (
                <div className="text-center">
                  ...
                  <div className="p-4 bg-gray-50 rounded-2xl text-left text-sm mb-4">
                  ...
                  <p className="text-xs text-gray-400 mt-2">Paiement en ligne bientôt disponible</p>
                </div>
              )}
            ...
            <div className="bg-white rounded-3xl border border-gray-100 p-6">
              ...
              <div className="space-y-2">
                ...
                {[
                  ...
                  <div key={cmd.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-xl text-sm">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 p-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="border border-blue-100 rounded-2xl p-5 hover:shadow-md transition-all">
                  ...
                  <p className="text-xs text-gray-500 mb-3">Table `driver_applications` (Supabase)</p>
