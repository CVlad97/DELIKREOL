...
export function LaunchNetworkPage() {
 ...
 Array.from(
 new Set([
 ...getMartiniqueServiceZones(),'Fort-de-France','Lamentin','Ducos','Riviere-Salee','Sainte-Luce','Le Marin','Le Francois','Secteur sud',
 ]),
 ).slice(0, 12),
 [],
 );
 ...
 const text = ['Bonjour, je souhaite faire une demande pro sur DELIKREOL Martinique.',
 ...
 <header className="sticky top-0 z-50 border-b border-primary/20 bg-white/95 backdrop-blur-xl">
 ...
 <a href="#client" className="rounded-full border border-primary/20 px-5 py-2.5 text-sm font-bold text-[#7c2d12]">Client</a>
 <a href="#ops" className="rounded-full border border-primary/20 px-5 py-2.5 text-sm font-bold text-[#7c2d12]">Ops</a>
 <a href="#partenaires" className="rounded-full border border-primary/20 px-5 py-2.5 text-sm font-bold text-[#7c2d12]">Partenaires</a>
 ...
 <main id="accueil">
 <section className="relative overflow-hidden border-b border-primary/20 bg-[radial-gradient(circle_at_10%_15%,rgba(251,146,60,0.24),transparent_30%),radial-gradient(circle_at_90%_8%,rgba(16,185,129,0.18),transparent_30%),linear-gradient(135deg,#fff7ed_0%,#fff_46%,#fff4e6_100%)]">
 <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 md:grid-cols-[1.05fr_0.95fr] md:py-16 lg:py-20">
 <div className="flex flex-col justify-center">
 <div className="mb-6 inline-flex w-fit items-center gap-2 rounded-full border border-primary/20 bg-white/80 px-4 py-2 text-xs font-black uppercase tracking-[0.22em] text-[hsl(var(--primary))] shadow-sm">
 ...
 <a href="#ops" className="inline-flex items-center gap-2 rounded-2xl border border-primary/20 bg-white px-6 py-4 font-bold text-[#7c2d12]">Voir le cockpit ops</a>
 <a href="#partenaires" className="inline-flex items-center gap-2 rounded-2xl border border-success/20 bg-success/[0.15] px-6 py-4 font-bold text-success">Voir le reseau partenaire</a>
 </div>
 ...
 <div className="rounded-[2rem] border border-primary/20 bg-white/92 p-6 shadow-2xl shadow-orange-900/10 backdrop-blur">
 ...
 <a href={shareLink} className="inline-flex items-center gap-2 rounded-2xl border border-primary/20 px-5 py-4 font-bold text-[#7c2d12]">Partager maintenant</a>
 </div>
 </div>
 </div>
 </section>
 ...
 <div className="rounded-[1.75rem] border border-primary/20 bg-[#fff8ed] p-6 shadow-sm">
 ...
 <span className="rounded-full bg-success/[0.15] px-3 py-1 text-xs font-black text-success">Simulation visible</span>
 </div>
 <div className="mt-6 grid gap-4 sm:grid-cols-2">
 ...
 <div className="rounded-[1.75rem] border border-primary/20 bg-[#24170f] p-6 text-white shadow-sm">
 <p className="text-xs font-black uppercase tracking-[0.24em] text-primary/60">Ecran client</p>
 ...
 <span className="rounded-full bg-emerald-400 px-3 py-1 text-xs font-black text-success">En cours</span>
 </div>
 ...
 <div className="rounded-[1.75rem] border border-primary/20 bg-white p-6 shadow-sm">
 <div className="flex items-center justify-between gap-4">
 <div>
 ...
 <span className="rounded-full bg-muted px-3 py-1 text-xs font-black text-muted-foreground">Reprise en main humaine</span>
 </div>
 <div className="mt-6 grid gap-4 sm:grid-cols-2">
 ...
 <div className="mt-6 rounded-[1.5rem] border border-primary/20 bg-[#fff8ed] p-5">
 ...
 <div className="rounded-[1.75rem] border border-primary/20 bg-[#24170f] p-6 text-white shadow-sm">
 <p className="text-xs font-black uppercase tracking-[0.24em] text-primary/60">Pipeline ops</p>
 ...
 <label className="flex items-center justify-between rounded-2xl border border-dashed border-primary/20 bg-primary/[0.05]/50 px-4 py-3 text-sm font-semibold text-stone-600 sm:col-span-2">
 ...
 <button type="submit" disabled={productStatus.kind ==='saving'} className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-success/[0.15]0 px-5 py-4 font-black text-white disabled:opacity-70">{productStatus.kind ==='saving' ?'Transmission en cours...' :'Transmettre le catalogue'}</button>
 ...
 <p className="text-sm font-black text-primary/60">Ce que le site prouve maintenant</p>
 ...
 <div className="rounded-[1.75rem] border border-white/10 bg-white/8 p-6">
 <p className="text-sm font-black text-primary/60">Actions immediates</p>
 ...
 <a href={proLink} className="rounded-2xl border border-success/30 bg-emerald-400 px-5 py-4 font-black text-success">Recevoir une demande pro</a>
 </div>
 </div>
 </div>
 </div>
 ...
 <footer className="border-t border-primary/20 bg-white py-8">
 ...
 <div className="fixed inset-x-0 bottom-0 z-50 border-t border-primary/20 bg-white/95 p-3 shadow-2xl backdrop-blur md:hidden">
 ...
 <a href="#ops" className="rounded-xl border border-primary/20 px-2 py-3 text-[#7c2d12]">Ops</a>
 <a href="#partenaires" className="rounded-xl border border-primary/20 px-2 py-3 text-[#7c2d12]">Pro</a>
 <a href="#lancement" className="rounded-xl border border-success/20 bg-success/[0.15] px-2 py-3 text-success">Go</a>
 </div>
 </div>
 </div>
 );
...
function TrustPill({ icon, label }: { icon: ReactNode; label: string }) {
 return <div className="flex items-center gap-2 rounded-2xl border border-primary/20 bg-white/80 px-4 py-3 text-sm font-black text-stone-700 shadow-sm">{icon}<span>{label}</span></div>;
}

function StatCard({ label, value }: { label: string; value: string }) {
 return <div className="rounded-[1.5rem] border border-primary/20 bg-white p-5 shadow-sm"><p className="text-sm font-bold text-stone-500">{label}</p><p className="mt-2 text-3xl font-black text-[#301607]">{value}</p></div>;
}

function ReadyFlag({ label, value }: { label: string; value: string }) {
 return <div className="rounded-2xl border border-primary/20 bg-primary/[0.05]/60 px-4 py-3 text-sm font-bold text-[#7c2d12]"><span className="mr-2 text-[hsl(var(--primary))]">●</span>{label} : {value}</div>;
}

function FeatureCard({ icon, title, text }: { icon: ReactNode; title: string; text: string }) {
 return <div className="rounded-[1.5rem] border border-primary/20 bg-white p-6 shadow-sm"><div className="mb-4 inline-flex rounded-2xl bg-primary/[0.15] p-3 text-[hsl(var(--primary))]">{icon}</div><h3 className="text-xl font-black text-[#301607]">{title}</h3><p className="mt-2 text-sm leading-6 text-stone-600">{text}</p></div>;
}

function MiniCard({ icon, title, text }: { icon: ReactNode; title: string; text: string }) {
 return <div className="rounded-[1.25rem] border border-primary/20 bg-white p-4 shadow-sm"><div className="mb-3 inline-flex rounded-xl bg-primary/[0.15] p-2 text-[hsl(var(--primary))]">{icon}</div><h4 className="text-sm font-black text-[#301607]">{title}</h4><p className="mt-1 text-sm leading-6 text-stone-600">{text}</p></div>;
}

function TimelineItem({ title, text, active }: { title: string; text: string; active?: boolean }) {
 return <div className="flex gap-3"><div className={`mt-1 h-3 w-3 flex-none rounded-full ${active ?'bg-success/[0.15]0' :'bg-orange-200'}`} /><div><p className="text-sm font-black text-[#301607]">{title}</p><p className="text-sm leading-6 text-stone-600">{text}</p></div></div>;
}
...
function OpsColumn({ title, items }: { title: string; items: string[] }) {
 return <div className="rounded-[1.25rem] bg-white/10 p-4"><p className="text-sm font-black text-primary/60">{title}</p><div className="mt-3 space-y-3">{items.map((item) => <div key={item} className="rounded-xl bg-white/10 p-3 text-sm font-semibold text-stone-100">{item}</div>)}</div></div>;
}

function DarkInfoCard({ title, icon, children }: { title: string; icon: ReactNode; children: ReactNode }) {
 return <div className="rounded-[1.75rem] border border-primary/20 bg-[#24170f] p-6 text-white shadow-sm"><div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-black uppercase tracking-[0.2em] text-primary/60">{icon}<span>{title}</span></div><div className="mt-4">{children}</div></div>;
}

function FormCard({ title, icon, children }: { title: string; icon: ReactNode; children: ReactNode }) {
 return <div className="rounded-[1.75rem] border border-primary/20 bg-white p-6 shadow-sm"><div className="mb-4 flex items-center gap-3 text-[hsl(var(--primary))]">{icon}<h3 className="text-xl font-black text-[#301607]">{title}</h3></div>{children}</div>;
}
...
function StatusBanner({ status }: { status: SubmitStatus }) {
 ...
 const tone = status.kind ==='success' ?'border-success/20 bg-success/[0.15] text-success' : status.kind ==='error' ?'border-rose-200 bg-rose-50 text-rose-700' :'border-primary/20 bg-primary/[0.05] text-orange-800';
 return <p className={`rounded-2xl border px-4 py-3 text-sm font-semibold ${tone}`}>{status.message}</p>;
}

function inputClass(extra ='') {
 return `rounded-2xl border border-primary/20 bg-primary/[0.05]/50 px-4 py-3 text-sm font-semibold text-stone-700 outline-none ring-orange-200 focus:ring-4 ${extra}`.trim();
}
