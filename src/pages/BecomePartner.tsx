...
export function BecomePartner({ onBack }: BecomePartnerProps) {
 ...
 benefits: ['Commission ultra-compétitive (20%)','Zéro frais d\'infrastructure','Marketing local ciblé inclus','Paiements hebdomadaires garantis',
 ],
 requirements: ['SIRET martiniquais valide','Conformité normes sanitaires','Catalogue produits qualitatifs',
 ],
 },
 {
 ...
 benefits: ['Gains immédiats après livraison','Planification 100% libre','IA Route Optimizer intégrée','Support chauffeur 24/7',
 ],
 requirements: ['Statut auto-entrepreneur','Véhicule motorisé ou vélo','Smartphone récent (GPS)',
 ],
 },
 {
 ...
 benefits: ['Revenu passif par colis','Flux de clients additionnels','Gestion simplifiée par QR Code','Zéro investissement matériel',
 ],
 requirements: ['Local commercial ou sécurisé','Zone de stockage dédiée','Horaires d\'accueil réguliers',
 ],
 },
 ];
 ...
 {selectedType ==='driver' && (
 <div className="rounded-[2rem] border border-success/20 bg-success/[0.15] p-6 space-y-4">
 ...
 <div key={item.label} className="rounded-2xl border border-success/20 bg-white p-4">
 <p className="text-xs font-black uppercase tracking-[0.2em] text-success">{item.label}</p>
