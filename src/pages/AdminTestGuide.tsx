...
export function AdminTestGuide() {
 ...
 steps: ['Cliquez sur"Changer de rôle" dans le header','Sélectionnez"Mode Client" ou revenez à l\'accueil','Connectez-vous avec un compte test ou créez-en un nouveau','Dans l\'app client, allez dans"Demandes"','Cliquez sur"Nouvelle demande" et remplissez le formulaire','Vérifiez que vous recevez un toast de succès',
 ],
 color:'blue',
 },
 {
 ...
 steps: ['Revenez en mode Admin (bouton"Espace Pro" dans le header)','Allez dans"Demandes" dans le menu admin','Vérifiez que votre demande test apparaît avec le statut"En attente"','La carte affiche : nom du client, adresse, détails de la demande','Le badge jaune indique"En attente"',
 ],
 color:'purple',
 },
 {
 ...
 steps: ['Cliquez sur"Prendre en charge" sur la demande test','Une modale s\'ouvre pour ajouter des notes admin (optionnel)','Ajoutez par exemple :"Demande reçue, recherche de partenaires en cours"','Cliquez sur"Passer en cours"','Vérifiez que le badge passe en bleu avec"En cours"','Les notes admin doivent apparaître en vert sous la demande',
 ],
 color:'orange',
 },
 {
 ...
 steps: ['Changez de rôle vers"Vendeur" ou"Point Relais"','Connectez-vous avec un compte partenaire test','Les demandes"En cours" de votre zone devraient être visibles','Badge"DEMANDE CLIENT" indique qu\'il s\'agit d\'une demande de conciergerie','Note : L\'assignation automatique n\'est pas encore implémentée',
 ],
 color:'green',
 },
 {
 ...
 steps: ['Revenez en mode Admin → Demandes','Cliquez sur"Marquer comme terminée" sur la demande test','Ou cliquez sur"Modifier notes" pour ajouter un commentaire final','Le badge passe en vert avec"Terminée"','Revenez en mode Client et vérifiez"Mes demandes"','La demande test apparaît avec le statut"Terminée"',
 ],
 color:'emerald',
 },
 ];
