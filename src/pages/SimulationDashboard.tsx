...
export function SimulationDashboard() {
 ...
 const confirmed = window.confirm('Voulez-vous vraiment réinitialiser les données de simulation ?\n\nCela supprimera toutes les données actuelles et rechargera les données de démonstration.'
 );
 ...
 <div className="w-16 h-16 rounded-2xl bg-success/[0.15]0/20 flex items-center justify-center">
 ...
 disabled={resetting}
 className="flex items-center gap-2 px-6 py-3 bg-primary/[0.05]0 hover:bg-primary disabled:bg-slate-700 text-white rounded-xl font-medium transition-colors"
 >
 ...
 {/* Candidatures */}
 <div className="bg-slate-800/50 backdrop-blur border border-slate-700 rounded-xl p-6 hover:border-primary transition-all">
 <div className="flex items-center gap-3 mb-4">
 ...
 <div className="flex items-start gap-3">
 <div className="w-6 h-6 rounded-full bg-success/[0.15]0/20 flex items-center justify-center flex-shrink-0 mt-0.5">
