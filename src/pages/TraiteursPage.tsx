...
function SocialLinks({ links, dark = false }: { links: SocialLinkSet; dark?: boolean }) {
 ...
 :'inline-flex items-center gap-2 rounded-full border border-primary/20 bg-white px-3 py-2 text-xs font-black text-[#7c2d12] hover:bg-[#fff8ef]'
 }
 >
 {item.icon}
...
export function TraiteursPage() {
 ...
 className="inline-flex items-center justify-center rounded-full border border-primary/20 bg-white px-4 py-2 text-sm font-black text-[#7c2d12] shadow-sm transition hover:-translate-y-0.5"
 >
 Retour catalogue
 </a>
 <a
 ...
 <section className="rounded-[2.25rem] border border-primary/20 bg-white p-6 shadow-soft sm:p-8">
 <div className="flex flex-wrap items-center gap-2">
 <Badge variant="secondary" className="rounded-full bg-[#fff3e5] text-[#7c2d12] hover:bg-[#fff3e5]">
 Espaces dédiés
 </Badge>
 <Badge variant="outline" className="rounded-full border-primary/20 text-[#7c2d12]">
 ...
 <Card className="overflow-hidden border-primary/20 bg-[#24170f] text-white shadow-elegant">
 ...
 <Separator className="mx-6 bg-primary/[0.15]" />
 ...
 <Badge key={item} variant="outline" className="rounded-full border-primary/20 bg-[#fffaf3] text-[#7c2d12]">
 {item}
 </Badge>
 ))}
 </div>
 ...
 <div key={image} className="overflow-hidden rounded-[1.4rem] border border-primary/20 bg-[#fffaf3] shadow-sm">
 <img
 src={image}
 ...
 <div className="rounded-[2rem] border border-primary/20 bg-white p-4 shadow-soft">
 <TabsList className="flex w-full flex-col gap-2 bg-transparent p-0 sm:flex-row">
 {traiteurSpacesState.map((space) => (
 <TabsTrigger
 key={space.slug}
 value={space.slug}
 className="flex-1 rounded-[1.25rem] border border-primary/20 bg-[#fffaf3] px-4 py-3 text-sm font-black text-[#5a4334] shadow-sm data-[state=active]:border-transparent data-[state=active]:bg-[#24170f] data-[state=active]:text-white"
 >
 {space.name}
 </TabsTrigger>
 ))}
 ...
 <div className="rounded-[1.35rem] border border-primary/20 bg-[#fffaf3] p-4">
 ...
 <Separator className="bg-primary/[0.15]" />
 ...
 <Button asChild variant="outline" className="border-primary/20 bg-white text-[#7c2d12] hover:bg-[#fff8ef]">
 ...
 <div key={item.name} className="overflow-hidden rounded-[1.25rem] border border-primary/20 bg-[#fffaf4] shadow-sm">
 {item.image && (
 ...
 <div className="mt-3 flex flex-wrap gap-2">
 <Badge variant="outline" className="rounded-full border-primary/20 bg-white text-[#7c2d12]">
 {item.category}
 </Badge>
 </div>
 </div>
...
function MetricCard({ icon, label, value }: { icon: ReactNode; label: string; value: string }) {
 return (
 <div className="rounded-[1.4rem] border border-primary/20 bg-[#fffaf4] p-4 shadow-sm">
...
function MiniStat({ label, value }: { label: string; value: string }) {
 return (
 <div className="rounded-[1.25rem] border border-primary/20 bg-[#fffaf4] p-4 shadow-sm">
