...
export function HomePage() {
 ...
 className="bg-transparent flex-1 outline-none text-foreground placeholder-gray-500 font-medium"
 />
 </div>
 </div>
 </header>
 ...
 <div className="flex items-center gap-3 bg-white rounded-xl px-5 py-4 shadow-lg border-2 border-primary/20 focus-within:border-orange-400 transition-colors">
 ...
 className="flex-1 outline-none text-foreground font-medium placeholder-gray-400"
 />
 </div>

 <div className="flex items-center gap-3 overflow-x-auto pb-2 scrollbar-hide">
 <Filter size={22} className="text-primary flex-shrink-0" />
 <button
 onClick={() => setSelectedType('all')}
 className={`px-5 py-2.5 rounded-xl font-bold whitespace-nowrap transition-all transform hover:scale-105 ${
 selectedType ==='all'
 ?'bg-gradient-to-r from-red-600 to-orange-600 text-white shadow-lg'
 :'bg-white text-foreground hover:bg-primary/[0.05] border-2 border-input'
 }`}
 >
 Tous
 </button>
 ...
 <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-primary/20 rounded-2xl p-12 text-center">
 <div className="text-6xl mb-4">🔍</div>
 <h3 className="text-2xl font-black text-foreground mb-2">Aucun résultat</h3>
...
function VendorDetailModal({ vendorId, onClose }: { vendorId: string; onClose: () => void }) {
 ...
 <div className="bg-white w-full sm:max-w-4xl sm:rounded-2xl rounded-t-3xl max-h-[90vh] flex flex-col shadow-2xl border-t-4 border-primary">
 <div className="p-5 border-b-2 border-primary/20 flex items-center justify-between sticky top-0 bg-gradient-to-r from-white to-orange-50">
 ...
 <div className="text-center py-16">
 <div className="text-6xl mb-4">📦</div>
 <h3 className="text-xl font-bold text-foreground mb-2">Aucun produit disponible</h3>
