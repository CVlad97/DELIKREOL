...
export function VendorView() {
 ...
 {pendingOrders.map(o => (
 <div key={o.id} className="bg-card rounded-2xl border-2 border-input p-5 space-y-3">
 ...
 className="flex-1 py-2.5 bg-primary/[0.05]0 text-white rounded-xl font-bold text-sm active:scale-95 transition-all flex items-center justify-center gap-2"
 >
