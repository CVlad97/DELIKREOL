...
export const ORDER_STATUS_COLORS: Record<string, string> = {
 pending:'bg-muted text-muted-foreground border-input',
 confirmed:'bg-sky-100 text-sky-800 border-sky-200',
 preparing:'bg-primary/[0.15] text-orange-800 border-primary/20',
 ready:'bg-teal-100 text-teal-800 border-teal-200',
 picked_up:'bg-cyan-100 text-cyan-800 border-cyan-200',
 in_transit:'bg-blue-100 text-blue-800 border-blue-200',
 at_relay:'bg-success/[0.15] text-success border-success/20',
 delivered:'bg-success/[0.15] text-success border-success/20',
};
...
export const STORAGE_COLORS: Record<string, string> = {
 ambient:'bg-success/[0.15] text-success',
